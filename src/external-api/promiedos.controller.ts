...
export class PromiedosController {
  ...
  /**
   * 🔍 Diagnóstico de horarios y timezone del servidor
   * Útil para debugging de problemas de timezone en producción
   */
  @Get('admin/timezone-diagnosis')
  @ApiOperation({
  ...
  /**
   * 📊 Información del scheduler y próximas ejecuciones
   */
  @Get('admin/scheduler-info')
  @ApiOperation({
